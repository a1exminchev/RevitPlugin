    ...
    public class FamilyCopier
    {
        ...
        private GenericForm CreateSweepInNewDoc(Sweep sweep)
        {
            ...
            Transform tProfile = Transform.CreateTranslation(new XYZ(0 - swPathSketchPlane.GetPlane().Origin.X,
                                                                 ...
                                                                 DeltaModul(sweep.ProfileSketch.SketchPlane.GetPlane().Origin.Z, sweep.ProfileSketch.SketchPlane.GetPlane().Origin.Z)));
        ...
        private GenericForm CreateSweptBlendInNewDoc(SweptBlend sweptblend)
        {
            ...
            Curve newPathCurve = Line.CreateBound(TakeSingleCurveArray(sweptblend.PathSketch.Profile).get_Item(0).GetEndPoint(0), 
                                                  TakeSingleCurveArray(sweptblend.PathSketch.Profile).get_Item(0).GetEndPoint(1));
